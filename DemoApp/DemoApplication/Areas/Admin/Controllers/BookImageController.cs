...
namespace DemoApplication.Areas.Admin.Controllers
{
    ...
    public class BookImageController : Controller
    {
        ...
        {
            return View(new ViewModels.BookImage.AddViewModel());
        }

        [HttpPost("{bookId}/image/add", Name = "admin-book-image-add")]
        public async Task<IActionResult> AddAsync([FromRoute] int bookId, [FromForm] ViewModels.BookImage.AddViewModel model)
        {
        ...
        [HttpGet("{bookImageId}/update", Name = "admin-book-image-update")]
        public async Task<IActionResult> UpdateAsync([FromRoute] int bookImageId)
        {
          

            var bookimage = await _dataContext.BookImages.FirstOrDefaultAsync(bi => bi.Id == bookImageId);
